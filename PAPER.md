...
Because δ was fixed after the first grid (§2.6), we also report, post hoc, the smallest symmetric bound each seed-mean interval satisfies (Supplementary S12): 0.045 for N4 and 0.096 for N5. The N4 verdict therefore holds for any bound down to 0.05; the N5 verdict holds at 0.10 but not at 0.075 and should be read as marginal.
